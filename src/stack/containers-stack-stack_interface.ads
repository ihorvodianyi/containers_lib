...
package Containers.Stack.Stack_Interface is

   pragma Pure;
   
   type Stack_Interface is interface;
   function Length (Container : in Stack_Interface) return Count_Type is abstract;
...
end Containers.Stack.Stack_Interface;
